...
// auth()
 ...
 if (!userExists) {
  return res.status(400).send("Cannot find user");
   ...
   if (res.header(token) === "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZWQzMmI0MTdmMDdhZDQ0NjQ4NjNjZTIiLCJpYXQiOjE1OTA4OTc4Mzh9.EpMZ8IKvUn3DvIGLq9mPIefaBCzdyPYTTsGX-zSrlKk") {
    res.json(userExists);
   }
