<template>
  <a
    ...
    target="_blank"
    class="open-project-card hover:no-underline shadow-sm rounded-lg bg-white w-full max-w-md md:max-w-lg mb-4 md:mb-5 lg:mb-4 p-3 md:p-4 md:py-4 md:pr-4 border hover:border-green"
  >
    <div>
